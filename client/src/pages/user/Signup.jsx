                ...
                <div className="bg-white p-4 text-sm flex-1">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                {...register("password", {
                                    required: "Field is required", pattern: {value:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{6,20}$/
,
...
,
                ...
                <div className="p-8 text-sm w-80">
                    ...
                    <p className="text-gray-600 mb-6">
                        Did someone refer you to our platform? Enter their referral code below!
                    </p>
                            ...
                            <div className="mt-4 animate-fadeIn">
                                ...
                                <input
                                    {...register("referralCode", {
                                        required: hasReferral ? "Please enter the referral code" : false,
                                        pattern: {
                                            value: /^[A-Z0-9]{6,12}$/,
