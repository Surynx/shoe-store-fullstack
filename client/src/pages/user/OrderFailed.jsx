      ...
      <div className="max-w-lg w-full bg-gray-50 rounded-lg border border-gray-300 shadow-md p-6 md:p-8">
        <div className="flex justify-center mb-5">
          <div className="w-28 h-28 flex items-center justify-center relative">
            ...
            <svg width="120" height="110" viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
              ...
              <g filter="url(#softShadow)">
                {/* Card base */}
                <rect x="20" y="30" width="120" height="75" rx="12" fill="url(#cardGrad)" />
                
                {/* Glossy overlay */}
                <rect x="20" y="30" width="120" height="75" rx="12" fill="url(#gloss)" />
                
                {/* Yellow chip */}
                <rect x="32" y="48" width="20" height="16" rx="4" fill="#FCD34D" />
                
                {/* Card number lines */}
                <rect x="32" y="75" width="22" height="5" rx="2.5" fill="#E0E7FF" opacity="0.9" />
                <rect x="58" y="75" width="22" height="5" rx="2.5" fill="#E0E7FF" opacity="0.9" />
                <rect x="84" y="75" width="22" height="5" rx="2.5" fill="#E0E7FF" opacity="0.9" />
                <rect x="110" y="75" width="14" height="5" rx="2.5" fill="#E0E7FF" opacity="0.9" />
                
                {/* Cardholder info lines */}
                <rect x="32" y="88" width="50" height="4" rx="2" fill="#C7D2FE" opacity="0.8" />
                <rect x="32" y="96" width="30" height="4" rx="2" fill="#C7D2FE" opacity="0.6" />
                
                {/* CVV area on right */}
                <rect x="115" y="48" width="18" height="6" rx="3" fill="#C7D2FE" opacity="0.8" />
              </g>
              ...
              <g filter="url(#softShadow)">
                ...
                {/* Exclamation mark */}
                <rect x="127" y="72" width="6" height="20" rx="3" fill="white" />
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-600 max-w-md mx-auto">
            Thank you for your purchase attempt. We were unable to process your payment. Please check your payment details and try again.
          </p>
        </div>

        <div className="space-y-3 mb-6">
          <div className="flex justify-between items-center">
            <span className="text-gray-600 text-sm font-bold">Order Number:</span>
            <span className="text-gray-900 font-bold text-sm">{orderId}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 text-sm font-bold">Order Total:</span>
