...
import EditBannerModal from "../modal/EditBanner";
...
function BannerList({ banners }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
                  ...
                  {deleteConfirm === banner._id ? (
                    ...
                    <div className="flex flex-col items-start">
                      <button
                        ...
                        className="p-1 text-blue-500 rounded text-xs font-bold flex items-center gap-1 cursor-pointer"
                        title="Edit Banner"
                      >
      ...
      <EditBannerModal isOpen={openEditModal} onClose={()=>setOpenEditModal(false)} banner={editBanner}/>
    </div>
  );
}
